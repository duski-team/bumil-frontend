<template>
    <div class="pertanyaanpengetahuan">
        <b-container>
            <b-row>
                <b-col md="12">
                    <b-row>
                        <b-col md="12" style="margin-top : 20px; margin-bottom: 20px">
                            ...
                            <strong>DATA PERTANYAAN PENGETAHUAN</strong>
                            </h3>
                        </b-col>
                    </b-row>
...
export default {
    ...
    mounted() {
        axios.get(ipBackend + "/pengetahuan/listAll", {
        headers: {
    ...
    methods: {
        ...
        signup(){
            let vm = this;
            axios.post(ipBackend + '/pengetahuan/register', {
      ...
      editData() {
            let vm = this;
            axios.post(ipBackend + "/pengetahuan/update/" + this.idEdit, {
      ...
      deleteItem(a,b) {
        let data = a
        let vm = this
              axios.post(ipBackend + "/pengetahuan/delete/" + data.id, {
                id:vm.items[b].id, 
              },
              {
                  headers: {
